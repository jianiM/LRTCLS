...
def parse_args():    
    ...
    parser.add_argument('-threshold1','--threshold1_topofallfeature', type=float, nargs='?', default=0.1,help='Performing k-fold for cross validation.')
...
if __name__=="__main__":
    ...
    plt.savefig("LRTCLS_CVtriple_ROC.pdf")
